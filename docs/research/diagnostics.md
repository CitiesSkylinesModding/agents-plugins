...
Ticket 07 owns the **lifecycle mechanism**: which hook throws, whether the system is left enabled, what the mod's `State` becomes, and where `OnDispose` fits.
...
Corrected 2026-08-05 in ticket 19's review, after the shipped reference had already been fixed — the earlier reading here cited `:443-446` and stopped one line before the `using`'s closing brace.
...
**Ruled (2026-08-04, ticket 18; conflicts.md).** The native leak-detection ruling does **not** reach this reference, and the order above stops where it stops.
...
**Ruled (2026-08-04, ticket 18; conflicts.md).** The Burst-gate ruling stays in `performance-and-memory`, and this reference stops at the attach precondition.
