...
- Marker names drift across versions; treat them as approximate labels, and expect a target below the docs' own version to expose fewer panels and markers than they describe.
