...
- `transportation-and-vehicles` — owns the delivery half of every trade: `DeliveryTruckSelectData.TrySelectItem` decides whether a shipment is worth a truck, and `DeliveryTruckAISystem` is where money changes hands for a weighted resource.
