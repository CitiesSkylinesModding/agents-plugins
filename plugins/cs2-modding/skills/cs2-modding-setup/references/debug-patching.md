...
[`diagnostics`](../../cs2-modding/references/technique/diagnostics/diagnostics.md) carries two further log signals, one sourced in each edit, plus two checks readable with the game closed.
